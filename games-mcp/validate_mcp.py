        ...
        try:
            ...
            if hasattr(mcp, '_tool_manager'):
                ...
                if hasattr(tool_manager, '_tools'):
                    ...
                    if missing_tools:
                        logger.error(f"   ERROR: Missing expected tools: {missing_tools}")
                    else:
...
def print_configuration_info():
    ...
    logger.info('      create_analysis_note(game_id="chess_1", game_type="chess", analysis_depth=20)')
    logger.info("   3. Knowledge Search:")
    logger.info('      search_game_knowledge(query="Sicilian defense", game_type="chess")')

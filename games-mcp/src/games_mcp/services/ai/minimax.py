...
class GameEngine:
    ...
    def is_terminal(self, board: Any) -> Tuple[bool, Optional[int]]:
        pass
...
class TicTacToeEngine(GameEngine):
    ...
    def is_terminal(self, board: List[int]) -> Tuple[bool, Optional[int]]:
        win_states = [
...
class ConnectFourEngine(GameEngine):
    ...
    def is_terminal(self, board: List[List[int]]) -> Tuple[bool, Optional[int]]:

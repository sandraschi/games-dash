...
def _resolve_service_account() -> str | None:
    ...
    # Relative to the repo root AND to the games-mcp directory (the .env
    # convention value is "firebase-service-account.json" next to games-mcp/).
    config_dir = Path(__file__).resolve().parent.parent.parent  # .../games-mcp

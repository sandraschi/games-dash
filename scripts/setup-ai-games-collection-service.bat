@echo off
REM AI Games Collection Service Setup Script
echo ============================================
echo    AI Games Collection Windows Service Setup
echo ============================================
echo.
...
echo.
echo Installing AI Games Collection Service...
echo.

REM Install the service
powershell -ExecutionPolicy Bypass -File "ai-games-collection-service.ps1" -Install
...
if %errorLevel% == 0 (
    ...
    echo ============================================
    echo.
    echo Your ai games collection servers will now start automatically
    echo when Windows boots up and stay running 24/7.
    echo.
    echo Service name: AIGamesCollectionService
    echo.
    echo Commands:

# AI Games Collection Windows Service
...
$ServiceName = "AIGamesCollectionService"
...
function Monitor-Services {
    Write-Log "=== AI Games Collection Service Monitor Started ==="
...
function Install-Service {
    Write-Host "Installing AI Games Collection Service..." -ForegroundColor Cyan
    ...
    # Configure service
    & $nssmPath set $ServiceName Description "AI Games Collection Service - Manages web server, sound service, and Cloudflare tunnel"
...
function Uninstall-Service {
    Write-Host "Uninstalling AI Games Collection Service..." -ForegroundColor Cyan
...
function Show-Status {
    Write-Host "AI Games Collection Service Status" -ForegroundColor Cyan
...
if ($Install) {
    ...
    Write-Host "AI Games Collection Service Manager" -ForegroundColor Green
    Write-Host "========================" -ForegroundColor Green
    Write-Host ""
    Write-Host "Usage:" -ForegroundColor White
    Write-Host "  .\ai-games-collection-service.ps1 -Install     Install as Windows service"
    Write-Host "  .\ai-games-collection-service.ps1 -Uninstall   Remove Windows service"
    Write-Host "  .\ai-games-collection-service.ps1 -Start       Start the service"
    Write-Host "  .\ai-games-collection-service.ps1 -Stop        Stop the service"
    Write-Host "  .\ai-games-collection-service.ps1 -Status      Show service status"
    Write-Host "  .\ai-games-collection-service.ps1 -Debug       Run in debug mode (foreground)"
    Write-Host ""

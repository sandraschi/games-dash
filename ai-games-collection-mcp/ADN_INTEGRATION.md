# ADN Integration Guide - AI Games Collection MCP Server
...
The AI Games Collection MCP Server integrates with **Advanced Memory (ADN)** to provide intelligent knowledge management, automatic analysis note creation, and strategic research capabilities. ADN serves as a comprehensive knowledge base that enhances game analysis with persistent learning and pattern recognition.
...
$env:AI_GAMES_COLLECTION_MCP_ADN_ENABLED = "true"
$env:AI_GAMES_COLLECTION_MCP_ADN_AUTO_ANALYZE = "true"
$env:AI_GAMES_COLLECTION_MCP_ADN_CACHE_SIZE = "1000"
```
...
```powershell
$env:AI_GAMES_COLLECTION_MCP_ADN_LOG_LEVEL = "DEBUG"
$env:AI_GAMES_COLLECTION_MCP_ADN_LOG_FILE = "adn_integration.log"
```

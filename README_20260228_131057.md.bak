# Games MCP Server - Complete Documentation
...
# Verify installation
python -c "import games_mcp.mcp_server; print('✅ Installation successful')"
```
...
The server automatically creates `data/games_mcp.db` with these tables:
...
The Games MCP Server integrates with **Advanced Memory (ADN)** for intelligent knowledge management and game analysis.
...
- Manual database reset: Delete `data/games_mcp.db`

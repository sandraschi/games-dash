# AI Games Collection MCP Server - Enhanced AI Integration Platform

## Overview

The **AI Games Collection MCP Server** is a comprehensive AI-powered platform for correspondence games, tournament management, and knowledge integration. It enables you to play correspondence chess, shogi, go, and other games through Claude/Cursor with advanced AI analysis, persistent game storage, and intelligent caching.
...
# Check status
python -c "from ai_games_collection_mcp.mcp_server import check_engine_status; import asyncio; print(asyncio.run(check_engine_status('chess')))"
```
...
```powershell
# Clean up cache
python -c "from ai_games_collection_mcp.mcp_server import cleanup_cache; import asyncio; print(asyncio.run(cleanup_cache()))"
```
...
- Cache location: `data/ai_games_collection_mcp.db`

### **Database Location**
- Default: `ai-games-collection/ai-games-collection-mcp/data/ai_games_collection_mcp.db`
...
- **Full Documentation**: `ai-games-collection-mcp/README_ENHANCEMENTS.md`
- **Technical Details**: `ai-games-collection-mcp/src/ai_games_collection_mcp/`
- **Validation Script**: `ai-games-collection-mcp/validate_mcp.py`
- **Test Suite**: `ai-games-collection-mcp/test_mcp_server.py`
